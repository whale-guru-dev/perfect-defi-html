...
jQuery(document).ready(function () {
  ...
  */
  ...
  $(".stake .accordion").each(function (a, b) {
    $(b).click(function () {
      if ($(b).hasClass('active') == true) {} else {
        ...
        $(".stake  .accordion").parent().find(".panel").css({
          "display": "none"
        });
  ...
  $("img.switcher").click(function () {
    ...
    $("img.switcher").toggleClass(' theme'); // setTimeout(function() {

    if ($("img.switcher").hasClass('theme')) {
      //Ligth Theme
      ...
      $("button.accordion").css("background", "#E6EAEE"); // $("button.accordion.active").css("color","#001529");

      $(".hamburger>svg>path").css("fill", "#001529");
      $("span.close").css("color", "#001529"); // if ($("button.accordion.active::after')) 
      ...
      $(".stake-button").css("border", 'none'); // $("button.accordion").css("background","#8095A9");
      ...
      $("span.dashboard").css("color", "#f9f9f94a"); // $("button.accordion").css("color","#8095A9");
      ...
      $(".stake-value").css("background", '#002B53'); // $(".follow-pd-staking").css("background",'#001B36');
  ...
  $(".faq .accordion").each(function (a, b) {
    $(b).click(function () {
      if ($(b).hasClass('active') == true) {} else {
        ...
        $(".faq  .accordion").parent().find(".panel").css({
          "display": "none"
        });
        $(b).toggleClass("active");
        $(b).parent().toggleClass("dropped");
